...
import { useCampaignsController } from '../';
import { useVideosController } from '../../videos/useVideosController';
import { useImagesController } from '../../images';
import { useAdPresetsController, getPrimaryTexts, getHeadlines, getDescriptions } from '../../ad-presets';
import { useProfilesController } from '../../profiles';
import { usePrelaunchUploaderEffect } from './usePrelaunchUploaderEffect';
import { useLaunchSelectionState } from './useLaunchSelectionState';
import { useLaunchDraftState } from './useLaunchDraftState';
...
export function useCampaignLaunchOrchestrator(
  campaignId: string,
  productIdParam?: string
): UseCampaignLaunchOrchestratorReturn {
  // ---------------------------------------------------------------------------
  // CONTROLLERS
  // ---------------------------------------------------------------------------
  ...
  // PRELAUNCH UPLOADER
  // ---------------------------------------------------------------------------
  const prelaunchUploader = usePrelaunchUploaderEffect({
  ...
  // ---------------------------------------------------------------------------
  const { saveStatus, lastSavedAt } = useLaunchAutoSaveEffect({
    campaignId,
    draft,
    selectedProfileId,
    reuseCreatives,
