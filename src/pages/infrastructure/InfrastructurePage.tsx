...
import { useTreeState } from '../../features/infrastructure/useTreeState';
import { useInfrastructureActions } from '../../features/infrastructure/useInfrastructureActions';
import { TreeCanvas } from '../../components/infrastructure/TreeCanvas';
import { SetTokenDialog } from '../../components/infrastructure/SetTokenDialog';
import { GenerateTokenDialog } from '../../components/infrastructure/GenerateTokenDialog';
import { SyncProgressDialog } from '../../components/infrastructure/SyncProgressDialog';
import { FacebookLoginButton } from '../../components/infrastructure/FacebookLoginButton';

export function InfrastructurePage() {
  const { data, isLoading, error, refetchAll } = useInfrastructureController();

  const treeState = useTreeState(data);
  const actions = useInfrastructureActions(data, refetchAll);
